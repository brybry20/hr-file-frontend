...
const STYLES = `
  ...
  .ca-title-icon { width:40px; height:40px; background:rgba(200,112,110,0.12); border:1px solid rgba(200,112,110,0.25); border-radius:10px; display:flex; align-items:center; justify-content:center; font-size:18px; }
  .ca-title { font-family:'DM Serif Display',serif; font-size:24px; color:#e8e4dc; letter-spacing:-0.5px; }
  .ca-count { font-size:11px; font-weight:600; letter-spacing:1.5px; text-transform:uppercase; color:#c8706e; background:rgba(200,112,110,0.1); border:1px solid rgba(200,112,110,0.2); padding:3px 10px; border-radius:20px; }
  .ca-add-btn { display:flex; align-items:center; gap:7px; padding:10px 20px; background:#c8706e; color:#0b0d12; border:none; border-radius:9px; font-family:'DM Sans',sans-serif; font-size:13px; font-weight:700; cursor:pointer; position:relative; overflow:hidden; transition:background 0.2s, box-shadow 0.2s, transform 0.1s; }
  .ca-add-btn::before { content:''; position:absolute; inset:0; background:linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.2) 50%, transparent 70%); transform:translateX(-100%); transition:transform 0.4s; }
  ...
  .ca-search { width:100%; background:#1c1f28; border:1px solid rgba(255,255,255,0.07); border-radius:10px; padding:12px 44px 12px 42px; font-family:'DM Sans',sans-serif; font-size:14px; color:#e8e4dc; outline:none; transition:border-color 0.2s, box-shadow 0.2s; caret-color:#c8706e; }
  ...
  .ca-search-clear { position:absolute; right:12px; top:50%; transform:translateY(-50%); background:#2a2d38; border:none; width:22px; height:22px; border-radius:50%; display:flex; align-items:center; justify-content:center; color:#9a96a0; font-size:14px; cursor:pointer; transition:background 0.2s, color 0.2s; }
  ...
  .ca-avatar { width:34px; height:34px; border-radius:8px; background:rgba(200,112,110,0.12); border:1px solid rgba(200,112,110,0.25); display:flex; align-items:center; justify-content:center; font-size:12px; font-weight:700; color:#c8706e; flex-shrink:0; }
  .ca-car-chip { display:inline-flex; align-items:center; gap:5px; padding:3px 10px; background:rgba(200,112,110,0.08); border:1px solid rgba(200,112,110,0.15); border-radius:5px; font-size:12.5px; color:#c8706e; }
  .ca-plate-chip { display:inline-block; padding:3px 10px; background:rgba(200,169,110,0.08); border:1px solid rgba(200,169,110,0.2); border-radius:5px; font-size:12.5px; color:#c8a96e; font-family:monospace; letter-spacing:1px; }
  .ca-muted { color:#5a5a6a; font-size:13px; }

  .ca-actions { display:flex; gap:5px; align-items:center; flex-wrap:nowrap; }
  .ca-btn-view, .ca-btn-edit, .ca-btn-delete { display:flex; align-items:center; justify-content:center; gap:5px; padding:7px 12px; border-radius:7px; font-family:'DM Sans',sans-serif; font-size:12px; font-weight:600; cursor:pointer; border:1px solid; transition:all 0.2s; white-space:nowrap; }
  ...
  .ca-overlay { position:fixed; top:0; left:0; right:0; bottom:0; z-index:9999; background:rgba(5,6,10,0.78); backdrop-filter:blur(8px); display:flex; align-items:center; justify-content:center; padding:20px; animation:caFadeIn 0.2s ease; }
  ...
  .ca-view-card { background:#161920; border:1px solid rgba(255,255,255,0.08); border-radius:20px; width:100%; max-width:480px; box-shadow:0 40px 100px rgba(0,0,0,0.7); animation:caScaleIn 0.25s cubic-bezier(0.16,1,0.3,1); overflow:hidden; }
  .ca-card-top { padding:28px 28px 22px; background:linear-gradient(135deg, rgba(200,112,110,0.08) 0%, transparent 60%); border-bottom:1px solid rgba(255,255,255,0.06); position:relative; }
  .ca-card-close { position:absolute; top:18px; right:18px; width:30px; height:30px; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.08); border-radius:7px; display:flex; align-items:center; justify-content:center; color:#9a96a0; font-size:16px; cursor:pointer; transition:background 0.2s, color 0.2s; }
  .ca-card-close:hover { background:rgba(255,255,255,0.1); color:#e8e4dc; }
  .ca-card-avatar-lg { width:56px; height:56px; border-radius:14px; background:rgba(200,112,110,0.15); border:1px solid rgba(200,112,110,0.3); display:flex; align-items:center; justify-content:center; font-size:24px; margin-bottom:14px; }
  ...
  .ca-form-modal { background:#161920; border:1px solid rgba(255,255,255,0.08); border-radius:20px; width:100%; max-width:560px; max-height:90vh; overflow-y:auto; box-shadow:0 40px 100px rgba(0,0,0,0.7); animation:caScaleIn 0.25s cubic-bezier(0.16,1,0.3,1); }
  ...
  .ca-form-head { padding:22px 24px; border-bottom:1px solid rgba(255,255,255,0.07); display:flex; align-items:center; justify-content:space-between; position:sticky; top:0; background:#161920; z-index:1; }
  ...
  .ca-field-input { width:100%; background:#1c1f28; border:1px solid rgba(255,255,255,0.07); border-radius:9px; padding:11px 14px; font-family:'DM Sans',sans-serif; font-size:14px; color:#e8e4dc; outline:none; transition:border-color 0.2s, box-shadow 0.2s; caret-color:#c8706e; }
  .ca-field-input::placeholder { color:#5a5a6a; }
  .ca-field-input:focus { border-color:rgba(200,112,110,0.4); box-shadow:0 0 0 3px rgba(200,112,110,0.1); }
  .ca-form-foot { padding:16px 24px; border-top:1px solid rgba(255,255,255,0.07); display:flex; gap:8px; justify-content:flex-end; position:sticky; bottom:0; background:#161920; }
  .ca-foot-save { padding:10px 22px; background:#c8706e; color:#0b0d12; border:none; border-radius:8px; font-family:'DM Sans',sans-serif; font-size:13px; font-weight:700; cursor:pointer; transition:background 0.2s, box-shadow 0.2s; }
  ...
  .ca-foot-cancel { padding:10px 18px; background:transparent; border:1px solid rgba(255,255,255,0.08); border-radius:8px; color:#9a96a0; font-family:'DM Sans',sans-serif; font-size:13px; font-weight:500; cursor:pointer; transition:all 0.2s; }
  .ca-foot-cancel:hover { border-color:rgba(255,255,255,0.15); color:#e8e4dc; background:rgba(255,255,255,0.04); }

  .ca-confirm-modal { background:#161920; border:1px solid rgba(224,90,90,0.2); border-radius:16px; width:100%; max-width:360px; padding:28px; box-shadow:0 40px 80px rgba(0,0,0,0.7); animation:caScaleIn 0.2s cubic-bezier(0.16,1,0.3,1); text-align:center; }
...
export default function CarsInventory({ onNotify }) {
  ...
  const fetchCars = async () => {
    ...
    catch { notify('error', 'Failed to load car records'); }
  };
  ...
  const handleSubmit = async () => {
    ...
    setSaving(true);
    try {
      if (editingCar) { await axios.put(`/api/cars/${editingCar.id}`, formData); notify('success', 'Car record updated'); }
      else            { await axios.post('/api/cars', formData); notify('success', 'Car record added'); }
      await fetchCars(); setShowModal(false);
    } catch { notify('error', 'Failed to save car record'); }
  ...
  const confirmDelete = async () => {
    try {
      ...
      await fetchCars(); setDeleteTarget(null);
      notify('success', 'Car record deleted');
    } catch { notify('error', 'Failed to delete car record'); }
  };
      ...
      <div className="ca-wrap">
        ...
        <div className="ca-table-container">
          <table className="ca-table">
            <thead>
              <tr>
                <th>Assigned To</th><th>Type of Car</th><th>Plate No.</th>
                <th>Autosweep</th><th>Card No.</th><th>Easytrip</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
              {filtered.length > 0 ? filtered.map((car, i) => (
                <tr key={car.id} style={{ animationDelay:`${i*35}ms` }}>
                  <td><div className="ca-name-cell"><div className="ca-avatar">{getInitials(car.assigned_to)}</div><span style={{fontWeight:500}}>{car.assigned_to}</span></div></td>
                  ...
                  <td>
                    <div className="ca-actions">
                      ...
                      <button className="ca-btn-delete" onClick={() => setDeleteTarget(car)}>
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6M14 11v6"/></svg>Delete
                      </button>
                    </div>
                  </td>
                </tr>
              ...
              <div className="ca-view-card" onClick={e => e.stopPropagation()}>
                ...
                <div className="ca-card-actions">
                  ...
                  <button className="ca-btn-delete" style={{flex:1,justifyContent:'center',padding:'10px'}} onClick={() => { setViewCar(null); setDeleteTarget(viewCar); }}>
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/></svg>Delete
                  </button>
                </div>
              </div>
            </div>
